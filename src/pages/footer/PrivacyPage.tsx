...
export default function PrivacyPage() {
  ...
  usePageMeta(
    ...
    isEn
      ? "LiBooks' privacy policy: how we collect, use and protect your data, in compliance with GDPR and local laws."
      : "Politique de confidentialité de LiBooks : comment nous collectons, utilisons et protégeons vos données, en conformité avec le RGPD et les législations locales."
  );
  return (
    <div className="min-h-screen bg-white dark:bg-surface-0">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
        <div className="flex items-center gap-3 mb-3">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white">{isEn ? 'Privacy Policy' : 'Politique de confidentialité'}</h1>
        </div>
        ...
        {isEn ? (
          <div className="space-y-8 text-gray-600 dark:text-gray-400 text-sm leading-relaxed">
            <section>
              <h2 className="text-lg font-medium text-gray-900 dark:text-white mb-2">1. Data controller</h2>
              <p>
                LiAfrik (Dubai, UAE & Yaoundé, Cameroon) is the controller for personal data collected on
                the LiBooks platform. For any question:
                <a href="mailto:info@liafrik.com" className="text-[#0057D9] hover:underline"> info@liafrik.com</a>.
              </p>
            </section>

            <section>
              <h2 className="text-lg font-medium text-gray-900 dark:text-white mb-2">2. Data collected</h2>
              <p>We collect the following data:</p>
              <ul className="mt-2 space-y-1 list-disc list-inside">
                <li><strong className="text-gray-900 dark:text-white">User account</strong>: email, password (encrypted), company name.</li>
                <li><strong className="text-gray-900 dark:text-white">Business data</strong>: invoices, customers, suppliers, stock, transactions — entered by the user.</li>
                <li><strong className="text-gray-900 dark:text-white">Technical data</strong>: IP address, browser type, usage logs for security purposes.</li>
                <li><strong className="text-gray-900 dark:text-white">Preferences</strong>: language, theme (light/dark), display settings.</li>
              </ul>
            </section>

            <section>
              <h2 className="text-lg font-medium text-gray-900 dark:text-white mb-2">3. Purposes of processing</h2>
              <p>Data is processed to:</p>
              <ul className="mt-2 space-y-1 list-disc list-inside">
                <li>Provide the LiBooks accounting and invoicing service.</li>
                <li>Enable multi-user management and tenant-based access control.</li>
                <li>Generate accounting documents (invoices, reports, PDFs).</li>
                <li>Provide technical support and maintenance.</li>
                <li>Improve the platform (aggregated, anonymized analytics).</li>
              </ul>
            </section>

            <section>
              <h2 className="text-lg font-medium text-gray-900 dark:text-white mb-2">4. Legal basis</h2>
              <p>
                Processing is based on contract performance (GDPR Article 6.1.b) for data necessary to the
                service's operation, and on consent (Article 6.1.a) for optional data (analytics, marketing
                communications).
              </p>
            </section>

            <section>
              <h2 className="text-lg font-medium text-gray-900 dark:text-white mb-2">5. Retention period</h2>
              <p>
                Business data (invoices, accounts, transactions) is kept for the entire duration of service
                use, plus 10 years after account closure, in line with OHADA accounting obligations.
                Technical data (logs) is kept for a maximum of 12 months.
              </p>
            </section>

            <section>
              <h2 className="text-lg font-medium text-gray-900 dark:text-white mb-2">6. Security</h2>
              <p>
                Data is encrypted at rest and in transit (TLS 1.3). Access to data is protected by
                Row Level Security (RLS) policies at the database level. Passwords are hashed with bcrypt.
                API keys and secrets are never exposed client-side.
              </p>
            </section>

            <section>
              <h2 className="text-lg font-medium text-gray-900 dark:text-white mb-2">7. GDPR compliance (European Union)</h2>
              <p>
                For our European customers, LiBooks complies with the General Data Protection Regulation
                (GDPR — EU Regulation 2016/679). You have the following rights:
              </p>
              <ul className="mt-2 space-y-1 list-disc list-inside">
                <li><strong className="text-gray-900 dark:text-white">Right of access</strong>: obtain a copy of your data.</li>
                <li><strong className="text-gray-900 dark:text-white">Right to rectification</strong>: correct inaccurate data.</li>
                <li><strong className="text-gray-900 dark:text-white">Right to erasure</strong> ("right to be forgotten").</li>
                <li><strong className="text-gray-900 dark:text-white">Right to portability</strong>: export your data in a structured format.</li>
                <li><strong className="text-gray-900 dark:text-white">Right to object</strong>: object to processing on legitimate grounds.</li>
              </ul>
              <p className="mt-2">
                To exercise these rights: <a href="mailto:info@liafrik.com" className="text-[#0057D9] hover:underline">info@liafrik.com</a>.
                You may also lodge a complaint with your national data protection authority.
              </p>
            </section>

            <section>
              <h2 className="text-lg font-medium text-gray-900 dark:text-white mb-2">8. Compliance with local data-protection laws</h2>
              <p>
                Beyond GDPR, LiBooks complies with data-protection laws in force in the countries where the
                service is available, including:
              </p>
              <ul className="mt-2 space-y-1 list-disc list-inside">
                <li><strong className="text-gray-900 dark:text-white">Cameroon</strong>: Law No. 2023/014 of 12 July 2023 on the protection of personal data.</li>
                <li><strong className="text-gray-900 dark:text-white">CEMAC</strong>: Directive No. 03/19/CEMAC/CM of 21 December 2019.</li>
                ...
                <li><strong className="text-gray-900 dark:text-white">South Africa</strong>: Protection of Personal Information Act (POPIA).</li>
              </ul>
              <p className="mt-2">
                For countries not listed, LiBooks applies equivalent protection standards.
              </p>
            </section>

            <section>
              <h2 className="text-lg font-medium text-gray-900 dark:text-white mb-2">9. Transfers outside the EU/EEA</h2>
              <p>
                Data may be processed from Dubai (UAE) as part of the platform's development and maintenance.
                LiAfrik ensures an adequate level of protection in line with the appropriate safeguards
                provided for by GDPR (standard contractual clauses, technical and organizational measures).
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                LiBooks only uses cookies essential to its operation (authentication session, language and
                theme preference). No advertising or third-party tracking cookie is used.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Data-protection questions: <a href="mailto:info@liafrik.com" className="text-[#0057D9] hover:underline">info@liafrik.com</a><br />
