    ...
    <div className="min-h-screen bg-white dark:bg-surface-0">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
        ...
        <div className="space-y-8 text-gray-600 dark:text-gray-400 text-sm leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-bold text-gray-900 dark:text-white mb-2">2. Données collectées</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-gray-900 dark:text-white mb-2">4. Base légale</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-gray-900 dark:text-white mb-2">5. Durée de conservation</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-gray-900 dark:text-white mb-2">6. Sécurité</h2>
            <p>
