...
export default function CookiePolicyPage() {
  ...
  usePageMeta(
    ...
    isEn
      ? "LiBooks' cookie policy: which cookies we use, why, and how to manage them."
      : "Politique de cookies de LiBooks : quels cookies nous utilisons, pourquoi, et comment les gérer."
  );
  return (
    <div className="min-h-screen bg-white dark:bg-surface-0">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
        <div className="flex items-center gap-3 mb-3">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white">{isEn ? 'Cookie Policy' : 'Politique de cookies'}</h1>
        </div>
        ...
        {isEn ? (
          <div className="space-y-8 text-gray-600 dark:text-gray-400 text-sm leading-relaxed">
            <section>
              <h2 className="text-lg font-medium text-gray-900 dark:text-white mb-2">1. What is a cookie?</h2>
              <p>
                A cookie is a small text file placed on your device when you visit a website. It allows the
                site to function, remembers your preferences, and helps analyze platform usage.
              </p>
            </section>

            <section>
              <h2 className="text-lg font-medium text-gray-900 dark:text-white mb-2">2. Cookies we use</h2>
              <p>LiBooks exclusively uses the following categories of cookies:</p>
              <ul className="mt-2 space-y-1 list-disc list-inside">
                <li><strong className="text-gray-900 dark:text-white">Strictly necessary cookies</strong>: authentication session, security (CSRF protection), subscription checkout flow.</li>
                <li><strong className="text-gray-900 dark:text-white">Preference cookies</strong>: chosen language, light/dark theme.</li>
                <li><strong className="text-gray-900 dark:text-white">Analytics cookies</strong> (optional, with consent): aggregated, anonymized usage statistics.</li>
              </ul>
              <p className="mt-2">
                No advertising or third-party commercial tracking cookie is ever placed without your explicit consent.
              </p>
            </section>

            <section>
              <h2 className="text-lg font-medium text-gray-900 dark:text-white mb-2">3. Retention period</h2>
              <p>
                Session cookies expire when the browser is closed. Preference and analytics cookies are kept for
                a maximum of 13 months, in line with data-protection recommendations.
              </p>
            </section>

            <section>
              <h2 className="text-lg font-medium text-gray-900 dark:text-white mb-2">4. Managing your cookies</h2>
              <p>
                You can configure your browser at any time to refuse non-essential cookies or to be warned before
                they are set. Refusing non-essential cookies does not prevent you from using LiBooks; only the
                cookies strictly necessary for the service to function cannot be disabled.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Questions about cookies: <a href="mailto:info@liafrik.com" className="text-[#0057D9] hover:underline">info@liafrik.com</a>
              </p>
            </section>
          </div>
        ) : (
